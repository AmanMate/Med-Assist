...
public class MessagesActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        messagesDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Messages").child(currentUserID);
