...
public class ProfileFragment extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        userDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Users").child(currentUserID);
        connectionsDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Connections");
        achievementDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Achievements").child(currentUserID);
        ...
        {
            userDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Users").child(intentUserID);
            achievementDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Achievements").child(intentUserID);
    ...
    private void OpenRemoveRequestedConnectionConfirmDialog()
    {
        ...
        yesbtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                cancelConnectionsDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Connections").child(currentUserID).child(intentUserID);
                cancelConnectionsDatabaseReference.removeValue();
                cancelConnectionsDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Connections").child(intentUserID).child(currentUserID);
                cancelConnectionsDatabaseReference.removeValue();
