...
public class HomeFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        foodDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Foods");
        ...
        foodDiaryDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("FoodDiaries").child(currentUserID).child(currentDate);
        waterDiaryDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("WaterDiaries").child(currentUserID).child(currentDate);
        workoutDiaryDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("WorkoutDiaries").child(currentUserID).child(currentDate);
