                ...
                userDatabaseReference.child(userID).addValueEventListener(new ValueEventListener()
                {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                    {
                        ...
                        requestsViewHolder.rejectBtn.setOnClickListener(new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v)
                            {
                                connectionsDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Connections").child(currentUserID).child(userID);
                                connectionsDatabaseReference.removeValue();
                                connectionsDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Connections").child(userID).child(currentUserID);
                                connectionsDatabaseReference.removeValue();
                            }
                        });
                    }
