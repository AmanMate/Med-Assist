...
public class PostCommentActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        commentDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Comments").child(intentPostID);
    ...
    private void OpenDeleteConfirmDialog(final String commentID)
    {
        ...
        yesbtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                commentDeleteDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Comments").child(intentPostID).child(commentID);
