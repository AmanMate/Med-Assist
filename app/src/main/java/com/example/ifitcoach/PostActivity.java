...
public class PostActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        userDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Users");
        postDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Posts");
        commentDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Comments");
        voteDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Votes");
            ...
            protected void onBindViewHolder(@NonNull final PostsViewHolder postsViewHolder, int i, @NonNull final UserPosts userPosts)
            {
                ...
                postsViewHolder.postAfterVoteButton.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        voteDeleteDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Votes").child(PostID).child(currentUserID);
    ...
    private void OpenDeleteConfirmDialog(final String postID)
    {
        ...
        yesbtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                postDeleteDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Posts").child(postID);
                postDeleteDatabaseReference.removeValue();
                postCommentDeleteDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Comments").child(postID);
                postCommentDeleteDatabaseReference.removeValue();
                postVoteDeleteDatabaseReference = FirebaseDatabase.getInstance("https://fitness-64201-default-rtdb.firebaseio.com").getReference().child("Votes").child(postID);
